...
Card(name="player.hp +=",cat=Category.FUNC, cast=Func("add_hp",False) ,color=Color.RED, cost=5),
Card(name="enemy.hp -=",cat=Category.FUNC, cast=Func("reduce_hp",True) ,color=Color.RED, cost=5),
